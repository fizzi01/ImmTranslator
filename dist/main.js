!function() {
    ...
    class BaseUIManager {
        ...
        addCSS() {
            ...
            style.textContent = '\n:root{--md-primary-50:#e8f6f9;--md-primary-100:#c6e9f0;--md-primary-200:#9fdae6;--md-primary-300:#76c8db;--md-primary-400:#58bbd4;--md-primary-500:#3aaecd;--md-primary-600:#349bc3;--md-primary-700:#2d85b5;--md-primary-800:#2770a7;--md-primary-900:#1c4e8f;--md-secondary-50:#fdf2f0;--md-secondary-100:#faddd7;--md-secondary-200:#f7c5bb;--md-secondary-300:#f3ac9f;--md-secondary-400:#f0988a;--md-secondary-500:#ed8575;--md-secondary-600:#eb7d6d;--md-secondary-700:#e87262;--md-secondary-800:#e56858;--md-secondary-900:#e05645;--md-surface-50:#f8fafb;--md-surface-100:#f1f5f7;--md-surface-200:#e8eff2;--md-surface-300:#d8e3e8;--md-surface-400:#b8c9d1;--md-surface-500:#94a8b3;--md-surface-600:#718590;--md-surface-700:#5a6b75;--md-surface-800:#42505a;--md-surface-900:#2a3439;--md-success-50:#f0faf4;--md-success-100:#dcf4e6;--md-success-500:#22c55e;--md-success-700:#15803d;--md-warning-50:#fffbeb;--md-warning-100:#fef3c7;--md-warning-500:#f59e0b;--md-warning-700:#d97706;--md-error-50:#fef2f2;--md-error-100:#fee2e2;--md-error-500:#ef4444;--md-error-700:#dc2626;--md-shadow-1:0px 2px 1px -1px rgba(0,0,0,0.2), 0px 1px 1px 0px rgba(0,0,0,0.14), 0px 1px 3px 0px rgba(0,0,0,0.12);--md-shadow-2:0px 3px 1px -2px rgba(0,0,0,0.2), 0px 2px 2px 0px rgba(0,0,0,0.14), 0px 1px 5px 0px rgba(0,0,0,0.12);--md-shadow-3:0px 3px 3px -2px rgba(0,0,0,0.2), 0px 3px 4px 0px rgba(0,0,0,0.14), 0px 1px 8px 0px rgba(0,0,0,0.12);--md-shadow-4:0px 2px 4px -1px rgba(0,0,0,0.2), 0px 4px 5px 0px rgba(0,0,0,0.14), 0px 1px 10px 0px rgba(0,0,0,0.12);--md-shadow-6:0px 3px 5px -1px rgba(0,0,0,0.2), 0px 6px 10px 0px rgba(0,0,0,0.14), 0px 1px 18px 0px rgba(0,0,0,0.12);--md-shadow-8:0px 5px 5px -3px rgba(0,0,0,0.2), 0px 8px 10px 1px rgba(0,0,0,0.14), 0px 3px 14px 2px rgba(0,0,0,0.12);--md-shadow-12:0px 7px 8px -4px rgba(0,0,0,0.2), 0px 12px 17px 2px rgba(0,0,0,0.14), 0px 5px 22px 4px rgba(0,0,0,0.12);--md-font-family:"Roboto", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;--md-font-weight-light:300;--md-font-weight-regular:400;--md-font-weight-medium:500;--md-font-weight-bold:700;--md-border-radius-small:4px;--md-border-radius-medium:8px;--md-border-radius-large:12px;--md-border-radius-extra-large:16px;--md-transition-duration-short:150ms;--md-transition-duration-medium:250ms;--md-transition-duration-long:300ms;--md-transition-easing-standard:cubic-bezier(0.4, 0.0, 0.2, 1);--md-transition-easing-decelerate:cubic-bezier(0.0, 0.0, 0.2, 1);--md-transition-easing-accelerate:cubic-bezier(0.4, 0.0, 1, 1)}@keyframes spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@keyframes md-fadein{from{opacity:0!important;transform:translateY(-8px) scale(.95)}to{opacity:1!important;transform:translateY(0) scale(1)}}@keyframes md-fadeout{from{opacity:1;transform:scale(1)}to{opacity:0;transform:scale(.95)}}@keyframes md-slide-up{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}#translationContainer{display:flex!important;flex-direction:row!important;align-items:center!important;gap:12px!important;transition:transform var(--md-transition-duration-long) var(--md-transition-easing-standard)!important;transform-origin:right!important;font-family:var(--md-font-family)!important}@media (max-width:768px){#immersiveTranslatorUI{bottom:16px!important;right:16px!important;gap:10px!important}#translationContainer{gap:8px!important;max-width:calc(100vw - 32px)!important;flex-wrap:nowrap!important}#notificationContainer{gap:10px!important;max-width:calc(100vw - 32px)!important}}@media (max-width:480px){#immersiveTranslatorUI{bottom:12px!important;right:12px!important;gap:8px!important}#translationContainer{gap:6px!important;max-width:calc(100vw - 24px)!important}#notificationContainer{gap:8px!important;max-width:calc(100vw - 24px)!important}}#translationContainer.hidden{transform:translateX(calc(100% - 96px))}@media (max-width:768px){#translationContainer.hidden{transform:translateX(calc(100% - 96px))}}@media (max-width:480px){#translationContainer.hidden{transform:translateX(calc(100% - 96px))}}#translationFeedbackBox{background:var(--md-surface-800)!important;color:var(--md-surface-50)!important;padding:16px 24px!important;border-radius:var(--md-border-radius-large)!important;font-family:var(--md-font-family)!important;font-size:16px!important;font-weight:var(--md-font-weight-regular)!important;display:flex!important;max-width:90vw!important;align-items:center!important;box-shadow:var(--md-shadow-6)!important;backdrop-filter:blur(8px)!important;-webkit-backdrop-filter:blur(8px)!important;transition:transform var(--md-transition-duration-long) var(--md-transition-easing-standard)!important;transform-origin:right!important;letter-spacing:0.25px!important;min-height:56px!important;word-wrap:break-word!important;overflow-wrap:break-word!important}@media (max-width:768px){#translationFeedbackBox{padding:14px 20px!important;font-size:15px!important;border-radius:var(--md-border-radius-medium)!important;min-height:52px!important;max-width:calc(100vw - 120px)!important}}@media (max-width:480px){#translationFeedbackBox{padding:12px 16px!important;font-size:14px!important;min-height:48px!important;max-width:calc(100vw - 100px)!important;line-height:1.3!important}}.immTransl-arrow{width:24px;height:24px;cursor:pointer;transition:transform var(--md-transition-duration-medium) var(--md-transition-easing-standard);margin-right:12px;align-items:center;display:flex;color:var(--md-surface-300);border-radius:50%;padding:8px;background:rgb(255 255 255 / .08);min-width:40px;min-height:40px;justify-content:center;touch-action:manipulation}.immTransl-arrow:hover{background:rgb(255 255 255 / .12);color:var(--md-surface-50)}.immTransl-arrow:active{background:rgb(255 255 255 / .16);transform:scale(.95)}@media (max-width:768px){.immTransl-arrow{width:20px;height:20px;min-width:44px;min-height:44px;padding:12px;margin-right:8px}}@media (max-width:480px){.immTransl-arrow{width:18px;height:18px;min-width:40px;min-height:40px;padding:11px;margin-right:6px}}#translationContainer.hidden .immTransl-arrow{transform:rotate(180deg)}#translationFeedbackBox .spinner{width:20px!important;height:20px!important;border:2px solid var(--md-primary-200)!important;border-top:2px solid var(--md-primary-500)!important;border-radius:50%!important;margin-right:12px!important;animation:spin 1s linear infinite;flex-shrink:0!important}@media (max-width:768px){#translationFeedbackBox .spinner{width:18px!important;height:18px!important;margin-right:10px!important}}@media (max-width:480px){#translationFeedbackBox .spinner{width:16px!important;height:16px!important;margin-right:8px!important}}#immersiveTranslatorUI{position:fixed!important;bottom:20px!important;right:20px!important;z-index:10000000!important;display:flex!important;flex-direction:column!important;align-items:flex-end!important;gap:12px!important;pointer-events:none!important;font-family:var(--md-font-family)!important}#immersiveTranslatorUI>*{pointer-events:auto!important}#notificationContainer{display:flex!important;flex-direction:column!important;gap:5px!important;max-width:90vw!important;font-family:var(--md-font-family)!important}#notificationContainer>*{pointer-events:auto!important}.notification{padding:16px 24px!important;border-radius:var(--md-border-radius-medium)!important;color:var(--md-surface-50)!important;font-family:var(--md-font-family)!important;font-size:14px!important;font-weight:var(--md-font-weight-regular)!important;box-shadow:var(--md-shadow-4)!important;animation:md-fadein var(--md-transition-duration-long) var(--md-transition-easing-decelerate)!important;letter-spacing:0.25px!important;backdrop-filter:blur(8px)!important;-webkit-backdrop-filter:blur(8px)!important;word-wrap:break-word!important;overflow-wrap:break-word!important;line-height:1.4!important;max-width:100%!important}@media (max-width:768px){.notification{padding:14px 20px!important;font-size:13px!important;border-radius:var(--md-border-radius-small)!important;line-height:1.3!important}}@media (max-width:480px){.notification{padding:12px 16px!important;font-size:12px!important;line-height:1.25!important}}.notification.error{background-color:var(--md-error-500)!important;color:var(--md-surface-50)!important}.notification.warning{background-color:var(--md-warning-500)!important;color:var(--md-surface-900)!important;font-weight:var(--md-font-weight-medium)!important}.notification.success{background-color:var(--md-success-500)!important;color:var(--md-surface-50)!important}.notification.info{background-color:var(--md-primary-500)!important;color:var(--md-surface-50)!important}.fade-out{animation:md-fadeout var(--md-transition-duration-medium) var(--md-transition-easing-accelerate) forwards!important}#translationControls{margin-left:16px!important;display:flex!important;gap:8px!important;align-items:center!important;flex-shrink:0!important}@media (max-width:768px){#translationControls{margin-left:12px!important;gap:6px!important}}@media (max-width:480px){#translationControls{margin-left:8px!important;gap:4px!important}}.immTransl-control-btn{width:40px!important;height:40px!important;border:none!important;border-radius:50%!important;cursor:pointer!important;outline:none!important;display:flex!important;align-items:center!important;justify-content:center!important;color:var(--md-surface-50)!important;font-size:16px!important;font-family:var(--md-font-family)!important;font-weight:var(--md-font-weight-medium)!important;transition:all var(--md-transition-duration-short) var(--md-transition-easing-standard)!important;box-shadow:var(--md-shadow-2)!important;position:relative!important;overflow:hidden!important;touch-action:manipulation!important;min-width:44px!important;min-height:44px!important;flex-shrink:0!important}@media (max-width:768px){.immTransl-control-btn{width:38px!important;height:38px!important;font-size:15px!important;min-width:44px!important;min-height:44px!important}}@media (max-width:480px){.immTransl-control-btn{width:36px!important;height:36px!important;font-size:14px!important;min-width:44px!important;min-height:44px!important}}.immTransl-control-btn::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:currentColor;opacity:0;transition:opacity var(--md-transition-duration-short) var(--md-transition-easing-standard);border-radius:inherit}.immTransl-control-btn:hover::before{opacity:.08}.immTransl-control-btn:focus::before{opacity:.12}.immTransl-control-btn:active{transform:scale(.96)!important;box-shadow:var(--md-shadow-1)!important}.immTransl-control-btn:active::before{opacity:.16}.immTransl-control-btn.pause{background-color:var(--md-warning-500)!important;color:var(--md-surface-900)!important}.immTransl-control-btn.resume{background-color:var(--md-success-500)!important;color:var(--md-surface-50)!important}.immTransl-control-btn.cancel{background-color:var(--md-error-500)!important;color:var(--md-surface-50)!important}.immTransl-control-btn.reset{background-color:var(--md-primary-500)!important;color:var(--md-surface-50)!important;width:48px!important;height:48px!important;box-shadow:var(--md-shadow-4)!important;min-width:48px!important;min-height:48px!important}@media (max-width:768px){.immTransl-control-btn.reset{width:46px!important;height:46px!important;min-width:48px!important;min-height:48px!important}}@media (max-width:480px){.immTransl-control-btn.reset{width:44px!important;height:44px!important;min-width:48px!important;min-height:48px!important}}.immTransl-control-btn:disabled{opacity:0.38!important;cursor:not-allowed!important;box-shadow:none!important}.immTransl-control-btn:disabled::before{display:none}.translation-wrapper{position:relative;align-items:center;font-family:var(--md-font-family)}.text-spinner{display:inline-block;width:16px;height:16px;border:2px solid var(--md-surface-400);border-top:2px solid var(--md-primary-500);border-radius:50%;animation:spin 1s linear infinite;margin-left:8px;flex:0 0 auto}@media (max-width:768px){.text-spinner{width:15px;height:15px;margin-left:6px;border-width:1.5px}}@media (max-width:480px){.text-spinner{width:14px;height:14px;margin-left:5px;border-width:1.5px}}.text-retry-button{width:20px;height:20px;background-color:var(--md-error-500);color:var(--md-surface-50);border:none;border-radius:var(--md-border-radius-small);padding:4px;display:inline-flex;align-items:center;justify-content:center;font-weight:var(--md-font-weight-medium);font-family:var(--md-font-family);text-transform:uppercase;cursor:pointer;outline:none;box-shadow:var(--md-shadow-2);transition:all var(--md-transition-duration-short) var(--md-transition-easing-standard);position:relative;cursor:pointer;z-index:1000;overflow:hidden;touch-action:manipulation;min-width:28px;min-height:28px}@media (max-width:768px){.text-retry-button{width:24px;height:24px;min-width:32px;min-height:32px;padding:4px}}@media (max-width:480px){.text-retry-button{width:22px;height:22px;min-width:30px;min-height:30px;padding:4px}}.text-retry-button::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:currentColor;opacity:0;transition:opacity var(--md-transition-duration-short) var(--md-transition-easing-standard);border-radius:inherit}.text-retry-button:hover{box-shadow:var(--md-shadow-4);transform:translateY(-1px)}.text-retry-button:hover::before{opacity:.08}.text-retry-button:active{box-shadow:var(--md-shadow-1);transform:translateY(0)}.text-retry-button:active::before{opacity:.16}.text-retry-button::after{position:absolute;top:0;left:0;right:0;bottom:0;background:#fff0;z-index:9999}@media (max-width:768px){button,.immTransl-control-btn,.immTransl-arrow,.text-retry-button{min-width:44px!important;min-height:44px!important}#translationFeedbackBox,.notification{-webkit-text-size-adjust:100%;text-size-adjust:100%}#translationContainer{padding:0!important}}@media (max-width:480px){#translationFeedbackBox{min-width:200px!important}.notification{min-width:180px!important}button,.immTransl-control-btn,.immTransl-arrow,.text-retry-button{min-width:40px!important;min-height:40px!important}}@media (max-width:768px) and (orientation:landscape){#immersiveTranslatorUI{bottom:8px!important}}@media (max-width:768px){input[type="text"],input[type="number"],input[type="email"],input[type="password"],textarea{font-size:16px!important}}.ocr-overlay{position:absolute!important;color:#fff!important;font-family:"Helvetica Neue",Arial,sans-serif!important;text-shadow:0 1px 2px rgb(0 0 0 / .6)!important;padding:4px 8px!important;border-radius:0px!important;display:flex;align-items:center!important;justify-content:center!important;z-index:9999!important;transition:opacity 0.3s ease!important;opacity:0.95!important;overflow:hidden!important;white-space:pre-wrap!important}.ocr-box{position:absolute!important;left:var(--pos-x,0);top:var(--pos-y,0);width:var(--box-width,auto);height:var(--box-height,auto);transition:left 0.05s ease,top 0.05s ease;background:linear-gradient(135deg,rgb(44 62 80 / .95),rgb(52 73 94 / .85));color:#fff;font-weight:400!important;display:flex;justify-content:center!important;align-items:center!important;flex-direction:column!important;-webkit-overflow-scrolling:touch;hyphens:auto!important;-webkit-hyphens:auto!important;line-height:1.2em!important;box-sizing:border-box!important;word-break:break-word!important;word-wrap:break-word!important;letter-spacing:normal!important;border-radius:8px!important;font-family:"Helvetica Neue",Arial,sans-serif!important;text-align:left!important;padding:2px 4px!important;overflow:auto!important;white-space:normal!important;z-index:9999!important}.ocr-box-text{font-size:100%}.ocr-box-text::-webkit-scrollbar{-webkit-appearance:none;width:0;height:0}.ocr-box::-webkit-scrollbar{-webkit-appearance:none;width:0;height:0}.ocr-box.dragging{touch-action:none;-webkit-touch-callout:none;user-select:none;-webkit-user-select:none}#pdf-container.dragging{touch-action:none;-webkit-touch-callout:none;-webkit-user-select:none;user-select:none}.ocr-box.ocr-box-error{background:linear-gradient(135deg,#f8e1e1,#fdf5f5);color:#a94442;box-shadow:0 4px 8px rgb(0 0 0 / .05);border-radius:8px;padding:0;overflow:hidden}.ocr-box.ocr-box-error:hover{transform:scale(1.02);box-shadow:0 8px 16px rgb(0 0 0 / .2)}.ocr-box .spinner{display:inline-block;width:auto;height:1em;aspect-ratio:1;border:3px solid rgb(255 255 255 / .1)!important;border-top:3px solid transparent!important;border-radius:50%!important;margin:auto!important;animation:spin 1s linear infinite}.ocr-box.ocr-box-error .ocr-retry-btn{display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:#f44336;color:#fff;font-size:clamp(6px, 5vw, 24px);font-weight:500;border:none;outline:none;border-radius:4px;cursor:pointer;text-transform:uppercase;letter-spacing:.5px;position:relative;overflow:hidden;transition:background 0.3s,box-shadow 0.3s}.ocr-box.ocr-box-error .ocr-retry-btn:hover{background:#e53935;box-shadow:0 4px 8px rgb(0 0 0 / .3)}.ocr-box.ocr-box-error .ocr-retry-btn:active{background:#d32f2f;box-shadow:0 2px 4px rgb(0 0 0 / .2)}.ocr-box.ocr-box-error .ocr-retry-btn::after{content:"";position:absolute;top:50%;left:50%;width:5px;height:5px;background:rgb(255 255 255 / .5);opacity:0;border-radius:50%;transform:translate(-50%,-50%) scale(1);transition:width 0.6s ease-out,height 0.6s ease-out,opacity 0.6s ease-out}.ocr-box.ocr-box-error .ocr-retry-btn:active::after{width:120%;height:120%;opacity:0;transition:0s}.img-container{position:relative!important;display:inline-block!important}#pdf-viewer{position:relative;width:auto;height:95%;display:flex;font-family:var(--md-font-family)}#pdf-toolbar{position:fixed;top:16px;left:50%;transform:translateX(-50%);width:90%;max-width:640px;height:64px;background:var(--md-surface-800);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:var(--md-border-radius-extra-large);color:var(--md-surface-50);display:flex;align-items:center;justify-content:space-between;z-index:1000000;box-shadow:var(--md-shadow-8);padding:0 20px;font-family:var(--md-font-family);font-weight:var(--md-font-weight-medium)}#pdf-toolbar button{background:rgb(255 255 255 / .08);border:none;color:var(--md-surface-50);padding:12px;margin:0 4px;border-radius:var(--md-border-radius-large);font-size:18px;cursor:pointer;transition:all var(--md-transition-duration-short) var(--md-transition-easing-standard);display:flex;align-items:center;justify-content:center;width:48px;height:48px;position:relative;overflow:hidden;font-family:var(--md-font-family);font-weight:var(--md-font-weight-medium)}#pdf-toolbar button::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:currentColor;opacity:0;transition:opacity var(--md-transition-duration-short) var(--md-transition-easing-standard);border-radius:inherit}#pdf-toolbar button:hover{background:rgb(255 255 255 / .12);box-shadow:var(--md-shadow-2)}#pdf-toolbar button:hover::before{opacity:.04}#pdf-toolbar button:focus::before{opacity:.08}#pdf-toolbar button:active{transform:scale(.96);box-shadow:var(--md-shadow-1)}#pdf-toolbar button:active::before{opacity:.12}#pdf-toolbar button:disabled{opacity:.38;cursor:not-allowed;box-shadow:none}#pdf-toolbar button:disabled::before{display:none}#pdf-toolbar button i{font-size:20px}#pdf-toolbar span{font-size:16px;font-weight:var(--md-font-weight-medium);text-align:center;flex-grow:1;padding:0 16px;letter-spacing:.5px;color:var(--md-surface-50)}.PDFtextLayer span{position:absolute!important}.PDFtextLayer{position:absolute;top:0;left:0;width:100%;height:100%}#pdf-container{margin-top:96px;flex:1;display:flex;flex-direction:column;gap:20px;overflow:visible;position:relative;margin:auto;width:95%;font-family:var(--md-font-family)}#pdf-container .ocr-container{position:relative;width:100%;box-shadow:var(--md-shadow-2);border-radius:var(--md-border-radius-medium);overflow:hidden;background:var(--md-surface-50)}#pdf-container canvas{width:100%!important;height:auto!important;display:block;border-radius:var(--md-border-radius-medium)}#pdfOptionsOverlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgb(0 0 0 / .32);display:flex;align-items:center;justify-content:center;z-index:10000;padding:24px;animation:md-fadein var(--md-transition-duration-long) var(--md-transition-easing-decelerate);font-family:var(--md-font-family);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px)}#pdfOptionsModal{background:var(--md-surface-50);border-radius:var(--md-border-radius-extra-large);padding:24px;width:100%;max-width:400px;box-shadow:var(--md-shadow-12);font-family:var(--md-font-family);color:var(--md-surface-900);opacity:0;transform:translateY(16px) scale(.95);animation:md-slide-up var(--md-transition-duration-long) var(--md-transition-easing-decelerate) forwards}#pdfOptionsModal h2{margin-top:0;font-size:24px;font-weight:var(--md-font-weight-regular);color:var(--md-surface-900);text-align:center;margin-bottom:24px;letter-spacing:.15px}#pdfOptionsModal form>div{margin-bottom:20px}#pdfOptionsModal label{color:var(--md-surface-700);font-size:14px;font-weight:var(--md-font-weight-medium);margin-left:12px;letter-spacing:.25px}#pdfOptionsModal input[type="text"],#pdfOptionsModal input[type="number"]{width:calc(100% - 24px);padding:16px 12px;margin-top:8px;border:1px solid var(--md-surface-400);border-radius:var(--md-border-radius-small);font-size:16px;font-family:var(--md-font-family);color:var(--md-surface-900);background:var(--md-surface-50);transition:border-color var(--md-transition-duration-short) var(--md-transition-easing-standard),box-shadow var(--md-transition-duration-short) var(--md-transition-easing-standard)}#pdfOptionsModal input[type="text"]:focus,#pdfOptionsModal input[type="number"]:focus{outline:none;border-color:var(--md-primary-500);box-shadow:0 0 0 2px rgb(33 150 243 / .2)}#pdfOptionsModal input[type="radio"]{appearance:none;-webkit-appearance:none;width:20px;height:20px;border:2px solid var(--md-surface-400);border-radius:50%;margin-right:12px;position:relative;cursor:pointer;transition:all var(--md-transition-duration-short) var(--md-transition-easing-standard)}#pdfOptionsModal input[type="radio"]:checked{border-color:var(--md-primary-500)}#pdfOptionsModal input[type="radio"]:checked::before{content:"";position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:10px;height:10px;background:var(--md-primary-500);border-radius:50%}#pdfOptionsModal .quality-container{display:flex;align-items:center;justify-content:center;gap:12px;margin:16px 0}#pdfOptionsModal .quality-container label{font-size:14px;color:var(--md-surface-700);font-weight:var(--md-font-weight-medium)}#pdfOptionsModal .quality-container input[type="range"]{flex:1;margin:0}#pdfOptionsModal .quality-container span{width:48px;text-align:center;font-size:14px;font-weight:var(--md-font-weight-medium);color:var(--md-primary-500);background:var(--md-primary-50);padding:4px 8px;border-radius:var(--md-border-radius-small)}#pdfOptionsModal input[type="range"]{appearance:none;-webkit-appearance:none;width:100%;height:4px;border-radius:2px;background:var(--md-surface-300);outline:none;transition:background var(--md-transition-duration-short) var(--md-transition-easing-standard)}#pdfOptionsModal input[type="range"]::-webkit-slider-runnable-track{width:100%;height:4px;cursor:pointer;background:var(--md-surface-300);border-radius:2px}#pdfOptionsModal input[type="range"]::-webkit-slider-thumb{appearance:none;-webkit-appearance:none;width:20px;height:20px;border-radius:50%;background:var(--md-primary-500);cursor:pointer;transition:all var(--md-transition-duration-short) var(--md-transition-easing-standard);box-shadow:var(--md-shadow-1);margin-top:-8px}#pdfOptionsModal input[type="range"]::-webkit-slider-thumb:hover{background:var(--md-primary-600);transform:scale(1.1);box-shadow:var(--md-shadow-2)}@media (max-width:480px){#pdfOptionsModal .quality-container{flex-direction:column;align-items:center}#pdfOptionsModal .quality-container input[type="range"]{width:100%;margin:8px 0}#pdfOptionsModal .quality-container span{text-align:center}}#pdfOptionsModal .button-group{display:flex;justify-content:flex-end;gap:12px;margin-top:32px}#pdfOptionsModal button{padding:12px 24px;font-size:14px;font-family:var(--md-font-family);font-weight:var(--md-font-weight-medium);border:none;border-radius:var(--md-border-radius-large);cursor:pointer;text-transform:uppercase;letter-spacing:.75px;min-width:64px;position:relative;overflow:hidden;transition:all var(--md-transition-duration-short) var(--md-transition-easing-standard)}#pdfOptionsModal button::before{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:currentColor;opacity:0;transition:opacity var(--md-transition-duration-short) var(--md-transition-easing-standard);border-radius:inherit}#pdfOptionsModal button:hover::before{opacity:.08}#pdfOptionsModal button:focus::before{opacity:.12}#pdfOptionsModal button:active::before{opacity:.16}#pdfOptionsModal button#cancelPdfOptions{background:#fff0;color:var(--md-surface-600);border:1px solid var(--md-surface-300)}#pdfOptionsModal button#cancelPdfOptions:hover{background:var(--md-surface-100);border-color:var(--md-surface-400)}#pdfOptionsModal button#confirmPdfOptions{background:var(--md-primary-500);color:var(--md-surface-50);box-shadow:var(--md-shadow-2)}#pdfOptionsModal button#confirmPdfOptions:hover{background:var(--md-primary-600);box-shadow:var(--md-shadow-4);transform:translateY(-1px)}#pdfOptionsModal button#confirmPdfOptions:active{transform:translateY(0);box-shadow:var(--md-shadow-1)}@media (max-width:768px){#pdfOptionsModal{padding:20px;max-width:calc(100vw - 40px);border-radius:var(--md-border-radius-large)}#pdfOptionsModal h2{font-size:22px;margin-bottom:20px}#pdfOptionsModal button{padding:14px 20px;font-size:14px;min-width:80px;min-height:44px}#pdfOptionsModal input[type="text"],#pdfOptionsModal input[type="number"]{padding:14px 12px;font-size:16px}#pdfOptionsOverlay{padding:20px}}@media (max-width:480px){#pdfOptionsModal{padding:16px;max-width:calc(100vw - 24px);border-radius:var(--md-border-radius-medium)}#pdfOptionsModal h2{font-size:20px;margin-bottom:16px}#pdfOptionsModal button{padding:12px 16px;font-size:14px;min-width:72px;min-height:44px}#pdfOptionsModal button#confirmPdfOptions{flex:1}#pdfOptionsModal .quality-container{flex-direction:column;align-items:stretch;gap:12px}#pdfOptionsModal .quality-container input[type="range"]{width:100%;margin:8px 0}#pdfOptionsModal .quality-container span{text-align:center;align-self:center}#pdfOptionsModal input[type="text"],#pdfOptionsModal input[type="number"]{padding:12px 10px;font-size:16px;width:calc(100% - 20px)}#pdfOptionsOverlay{padding:12px}}@media (max-width:768px){#pdf-toolbar{width:95%;height:60px;padding:0 16px;top:12px}#pdf-toolbar button{width:42px;height:42px;margin:0 2px;font-size:16px;min-width:44px;min-height:44px}#pdf-toolbar button i{font-size:18px}#pdf-toolbar span{font-size:15px;padding:0 12px}#pdf-container{margin-top:88px;gap:16px;width:98%}#pdf-toolbar #pageIndicator,#pdf-toolbar #zoomIndicator{font-size:13px}}@media (max-width:480px){#pdf-toolbar{height:56px;padding:0 12px;top:8px}#pdf-toolbar button{width:38px;height:38px;margin:0 1px;font-size:14px}#pdf-toolbar button i{font-size:16px}#pdf-toolbar span{font-size:14px;padding:0 8px}#pdf-container{margin-top:80px;gap:12px;width:99%}#pdf-toolbar #pageIndicator,#pdf-toolbar #zoomIndicator{font-size:12px}}@media (max-width:480px){.ocr-box{padding:1px 2px!important;border-radius:4px!important}.ocr-overlay{padding:2px 4px!important}}\n', 
    ...
    class PDFUIManager extends BaseUIManager {
        ...
        async exportPdfCallback() {
            ...
            if (unrendered.length > 0) {
                ...
                for (const c of unrendered) {
                    if (this.pdfDoc && "placeholder" === c.dataset.pageState) {
        ...
        _applyCachedTranslation(container) {
            ...
            OCRStrategy.enableDragResizeForBoxes(canvas, null);
